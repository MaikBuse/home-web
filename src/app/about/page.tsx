...
export const metadata: Metadata = {
  title: 'About',
  description:
    "I’m Maik Buse. I live in Hamburg, where I work on things I care about.",
}
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2 border-b border-zinc-700/40">
            ...
            <div className="mt-6 space-y-7 text-base text-zinc-400">
              ...
              <p>
                That same curiosity carried me from hands-on project management into leading an entire IT department,
                and eventually into founding a startup. That venture taught me as much about resilience and people
                as it did about product and technology. Each step taught me that good engineering and good leadership aren&apos;t separate things.
              </p>
              <p>
                Today, as Head of Technology Consulting, I lead a team that works across cloud architecture,
                full-stack development, and platform engineering. I&apos;m still as curious about technology as I was
                staying up late as a kid. That hasn&apos;t changed.
              </p>
            </div>
