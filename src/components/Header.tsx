    ...
    <Popover {...props}>
      ...
      <Transition>
        <TransitionChild
          ...
          leaveTo="opacity-0"
        >
          <PopoverOverlay className="fixed inset-0 z-50 backdrop-blur-sm bg-black/80" />
        </TransitionChild>
        <TransitionChild
          as={Fragment}
          enter="duration-150 ease-out"
  ...
  return (
    <>
      <header
        ...
        style={{
          height: isHomePage
            ? 'var(--header-height, 11.25rem)'
            : 'var(--header-height, 4rem)',
          marginBottom: isHomePage
            ? 'var(--header-mb, -7.25rem)'
            : 'var(--header-mb, 0px)',
        }}
      >
        {isHomePage && (
            ...
            >
              ...
              >
                <div className="relative">
                  <Avatar
                    large
                    className="block h-40 w-40 origin-left"
      ...
      {isHomePage && (
        <div
          className="flex-none"
          style={{ height: 'var(--content-offset, 7.25rem)' }}
        />
      )}
    </>
  )
