...
import templeImage from '@/images/photos/temple.png'
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
            <Link
              ...
              href={"/about"}>
              <Image
                className="h-72 w-full rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm brightness-90 bg-zinc-800"
                src={templeImage}
                placeholder="blur"
            ...
            <div className="w-full flex-auto">
              ...
              <p className="text-justify mt-6 text-lg leading-8 text-gray-300">
                Want to talk about a project, swap ideas, or just say hi? Drop me an email. I&apos;m always happy to hear from people.
              </p>
