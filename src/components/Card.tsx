...
Card.Link = function CardLink({
  ...
  return (
    <>
      <div className="absolute -inset-x-4 -inset-y-10 z-0 scale-95 opacity-80 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl bg-zinc-800/50" />
      <Link {...props}>
