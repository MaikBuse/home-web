...
export function GoogleGemini({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <GoogleGeminiEffect
        title="Leading Projects with Hands-on Expertise"
        description="Bringing it all together with the Insight Only Experience Can Offer, Ensuring Every Task Meets the Standard of Excellence Expected by Those Who Do the Work Themselves."
        pathLengths={[
          pathLengthFirst,
          pathLengthSecond,
          pathLengthThird,
...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className="h-full inset-0 sm:px-8 flex justify-center">
      <div className={cn("sticky h-[50rem] top-[10rem] bottom-[15rem] w-full max-w-7xl lg:px-8", className)}>
        ...
        <Link href={"/skillset/project"}>
          <svg
            ...
            className="absolute -top-60 md:-top-40 inset-0 w-full max-w-7xl lg:px-8"
          >
            <motion.path
