...
export function GoogleGemini({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <GoogleGeminiEffect
        title="Technical leadership, grounded in practice"
        description="Building teams and solutions with the kind of understanding that only comes from doing the work yourself."
        pathLengths={[
          pathLengthFirst,
          pathLengthSecond,
          pathLengthThird,
